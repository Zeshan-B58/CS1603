...
public class Game {
	...
	public String getGameScore() {
		...
		switch (findGameState()) {
			case 'g':
				return player1.getScore().toString() + " " + player2.getScore().toString(); // Regular Game
			case 'e':
				return player1.getScore().toString() + " all"; // Regular Game
			case 'd':
				return "Deuce"; // Deuce
			case 'a':
				return player1HasHigherScore() ? "Advantage player1" : "Advantage player2"; // Advantage
			case 'w':
				return player1HasHigherScore() ? player1.getName() + " wins" : player2.getName() + " wins"; // There is
																											// a winner
			default:
				break;
		}
